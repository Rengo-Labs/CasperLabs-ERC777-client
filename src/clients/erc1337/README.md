...
## Usage example
To use this class, you have to import the next modules: `ERC1337`, `casper-js-sdk`, `utils` and `ERC777`
```
import ERC1337 from "../../clients/erc777_recipient/ERC1337";
...
```
To install the ERC1337, you must firstly install the [ERC1820](src/jobs/erc1820/installer.js)
and [ERC777](src/jobs/erc777/installer.js) to get the **erc1820 contract hash**;
and then, you have to copy it and pass it as a [ERC1337](src/jobs/erc777/installer.js) parameter.
```
...
const erc777Recipient = new ERC1337()
