...
const run = async () => {
    ...
    await erc1337.initContract("hash-7549cf77d241885090ee32e3bfde1bdc2ecee774cc0d37cce275ccac23490ce4")

    await erc1337.createSubscriptionHash(RuntimeArgs.fromMap({
        from: CLValueBuilder.byteArray(ownerHash),
        public: CLValueBuilder.publicKey(recipientHash.value(), CLPublicKeyTag.ED25519)
    }))
}
